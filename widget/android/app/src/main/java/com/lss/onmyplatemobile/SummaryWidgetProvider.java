...
public class SummaryWidgetProvider extends AppWidgetProvider {
    private static final String ACTION_OPEN_SUMMARY = "com.lss.onmyplatemobile.action.OPEN_SUMMARY";
    private static final String ACTION_PREVIOUS_WEEK = "com.lss.onmyplatemobile.action.WIDGET_PREVIOUS_WEEK";
    private static final String ACTION_NEXT_WEEK = "com.lss.onmyplatemobile.action.WIDGET_NEXT_WEEK";
    private static final String ACTION_TOGGLE_VIEWPORT = "com.lss.onmyplatemobile.action.WIDGET_TOGGLE_VIEWPORT";
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        SharedPreferences prefs = PlannerWidgetPlugin.getPrefs(context);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_OPEN_SUMMARY.equals(action)) {
            PlannerWidgetPlugin.savePendingRoute(context, "/summary");
    ...
    private static class SharedPreferencesSnapshot {
        ...
        static SharedPreferencesSnapshot from(Context context) {
            try {
                String raw = PlannerWidgetPlugin.getPrefs(context).getString(PlannerWidgetPlugin.KEY_SUMMARY_SNAPSHOT, "{}");
